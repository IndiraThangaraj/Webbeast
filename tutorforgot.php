...
if (isset($_POST['submit'])) {
  ...
  if ($row > 0) {
    ...
    header('location:tutorpass.php');
  } else {
    echo "<script>alert('Invalid details. Please try with valid details');</script>";
    echo "<script>window.location.href ='tutorforgot.php'</script>";
  }
}
?>
  ...
  <div class="mainDiv">
    <div class="cardStyle">
      <form action="" method="post" name="signupForm" id="signupForm">
        ...
        <div class="inputDiv">
          <label class="inputLabel" for="confirmPassword">Registered Contact number</label>
