...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($conn, "UPDATE tutor_data set name='$name',address='$address',age='$age',contact='$contact',state='$state',edu='$edu',type='$type',mode='$mode',experience='$experience' where id='" . $_SESSION['id'] . "'");
    if ($sql) {
...
if (isset($_POST["upload"])) {
    ...
    if (!empty($_FILES["image"]["name"])) {
        ...
        if (in_array($fileType, $allowTypes)) {
            ...
            $sql2 = mysqli_query($conn, "UPDATE tutor_data SET image='$imgContent' where id='" . $_SESSION['id'] . "'");
...
<head>
    ...
    <title>Tutor Profile Edit</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="p-3 py-5">
                            ...
                            <div class="col-md-12"><label class="labels">School Name</label><input type="text" class="form-control" name="edu" value="<?php echo htmlentities($data['edu']); ?>"></div>
                            ...
                            <div class="col-md-12"><label class="labels">Study Mode</label><input type="text" class="form-control" name="mode" value="<?php echo htmlentities($data['mode']); ?>"></div>
                            <div class="col-md-12"><label class="labels">Experience</label><textarea class="form-control" name="experience"> <?php echo htmlentities($data['experience']); ?></textarea> </div>
                        </div>
                    </div>
                </div>
        </form>
