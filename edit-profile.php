...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "Update users set name='$fname',email='$email' where id='" . $_SESSION['id'] . "'");
	if ($sql) {
...
<head>
	...
	<!-- Main css -->
	<link rel="stylesheet" href="/public/css/css/EditProfile.css" />
</head>
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												<<?php
													...
													?> <h4>
													<?php echo htmlentities($data['name']); ?>'s Profile
													</h4>
													<p><b>Profile Reg. Date: </b>
														<?php echo htmlentities($data['regDate']); ?>
													</p>
													<?php if ($data['updationDate']) { ?>
														<p><b>Profile Last Updation Date: </b><?php echo htmlentities($data['updationDate']); ?>
														</p>
														<!--<?php } ?>-->
														<hr />
											...
											<div class="form-group">
												...
												<a href="change-emaild.html">Update your email id</a>
											</div>
