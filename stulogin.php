...
if (isset($_POST['submit'])) {
    $ret = mysqli_query($conn, "SELECT * FROM student WHERE email='" . $_POST['email'] . "' and password='" . md5($_POST['password']) . "'");
        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure><img src="/public/images/stulog.png" alt="sing up image"></figure>
                    <a href="sturegister.php" class="signup-image-link">Register Now</a>
                </div>
                ...
                <div class="signin-form">
                    ...
                    <form name="login" method="post" class="register-form" id="login-form">
                        ...
                        <div class="form-group">
                            <a href="stuforgot.php" class="signup-image-link">Forgot Password</a>
                        </div>
