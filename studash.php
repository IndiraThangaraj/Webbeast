                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body" style="background-color:#ffccea ;">
                                        <span class="fa-stack fa-2x"> <i class="fa fa-book"></i> </span>
                                        <h2 class="StepTitle">Manage Subject</h2>
                            ...
                            <div class="col-sm-6">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body" style="background-color:#ffccea ;">
                                        <span class="fa-stack fa-2x"> <i class="fa fa-calendar"></i> </span>
                                        <h2 class="StepTitle">Timetable</h2>
                            ...
                            <div class="col-sm-6">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body" style="background-color:#ffccea ;">
                                        ...
                                        <h2 class="StepTitle">Extra Academic</h2>

                                        <p class="links cl-effect-1">
                                        <a href="book-appointment.php">
                                                <a href="ExtraAcademic.php">
                                                Click Here
                                                </a>
                                            </a>
                                        </p>
