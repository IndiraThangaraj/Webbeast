...
<head>
    ...
    <script type="text/javascript">
        function valid() {
            if (
                document.register-form.pass.value !=
                document.register-form.re_pass.value
            ) {
                alert(
                    "Password and Confirm Password Field do not match  !!"
                );
                document.register-form.password_again.focus();
                return false;
            }
            return true;
        }
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" name="register-form" id="register-form" onSubmit="return valid()" ;>
