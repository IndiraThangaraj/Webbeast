...
if (isset($_POST['submit'])) {
  ...
  if ($num > 0) {
    ...
    $log = mysqli_query($con, "insert into userlog(uid,usermail,userip,status) values('" . $_SESSION['id'] . "','" . $_SESSION['login'] . "','$uip','$status')");
    ...
    $uip = $_SERVER['REMOTE_ADDR'];
    $status = 0;
    mysqli_query($con, "insert into userlog(usermail,userip,status) values('" . $_SESSION['login'] . "','$uip','$status')");
